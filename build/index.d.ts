...
export declare const createIotesReactReduxHook: (topology: TopologyMap<any, any>, strategy: Strategy<any, any>, reduxType?: string, busType?: string) => IotesReactReduxHook;
export {};
